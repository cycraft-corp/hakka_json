...
function(build_icu_windows)
    ...
    elseif(ICU_ARCH STREQUAL "x64" OR ICU_ARCH STREQUAL "x86_64" OR ICU_ARCH STREQUAL "AMD64")
        set(MSBUILD_PLATFORM "x64")
        set(WINDOWS_SRC_BIN_DIR "${ICU_SRC_DIR}/bin64")
        set(WINDOWS_SRC_LIB_DIR "${ICU_SRC_DIR}/lib64")
    elseif(ICU_ARCH STREQUAL "ARM64" OR ICU_ARCH STREQUAL "aarch64" OR ICU_ARCH STREQUAL "arm64")
        set(MSBUILD_PLATFORM "ARM64")
        set(WINDOWS_SRC_BIN_DIR "${ICU_SRC_DIR}/binARM64")
        set(WINDOWS_SRC_LIB_DIR "${ICU_SRC_DIR}/libARM64")
    else()
        message(FATAL_ERROR "Unsupported architecture: ${ICU_ARCH}. Please specify 'x86', 'x64', or 'ARM64'.")
    endif()
