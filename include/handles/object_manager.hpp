#ifndef __HAKKA_JSON_HANDLE_OBJECT_MANAGER_HPP__
#define __HAKKA_JSON_HANDLE_OBJECT_MANAGER_HPP__
#pragma once
...
class ObjectManagerCompact : public JsonHandleManagerCompact
{
    ObjectManagerCompact() = default;
    uint32_t get_index(HandleManagerToken token) const;

public:
    static constexpr auto object_mask = 0xC0000000; // 1100 0000 0000 0000 0000 0000 0000 0000
    static ObjectManagerCompact &get_instance();
    ~ObjectManagerCompact() = default;
...
#endif // __HAKKA_JSON_HANDLE_OBJECT_MANAGER_HPP__