...
| **Linux** | Clang/LLVM | 15, 16, 17, 18, 19, 20, 21, 22 | ![Clang](https://img.shields.io/github/actions/workflow/status/cycraft-corp/hakka_json/sanitize-build.yml?branch=main&label=Clang) |
